...
public class App {
    ...
    public static Veterinario crearVeterinario(){
        ...
        Veterinario veterinario=new Veterinario("Paco", 189, Especializacion.CARDIOLOGIA,fechaDeNacimiento, "314959439", "vete@gmail.com");
        return veterinario;
    }

    public static Veterinario crearVeterinario2(){
        Date fechaDeNacimiento= Date.valueOf("2000-04-05");
        Veterinario veterinario=new Veterinario("Ernestillo", 18, Especializacion.CARDIOLOGIA,fechaDeNacimiento, "314959439", "veteri@gmail.com");
        return veterinario;
    }

    public static Mascota crearMascota(){
        Mascota mascota=new Mascota("pepito", "Tigre montes", "atigrado", Genero.HEMBRA, "amarillo", 24.5, 193, Estado.RECUPERADO);
        return mascota;
    }

    public static Mascota crearMascota2(){
        Mascota mascota=new Mascota("Ramiris", "Tigre montes", "atigrado", Genero.HEMBRA, "amarillo", 24.5, 14, Estado.RECUPERADO);
        return mascota;
    }
